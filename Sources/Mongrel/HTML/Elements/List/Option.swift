...
public extension Option {
    ...
    func accessKey(_ key: String) -> Option {
    ...
    ///   attribute should be added.
    func allowsSpellcheck(_ value: Bool) -> Option {
    ...
    func `class`(_ name: String) -> Option {
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> Option {
    ...
    func customAttribute(key: String, value: String) -> Option {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> Option {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func hidden(_ value: Bool) -> Option {
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> Option {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> Option {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> Option {
    ...
    func styles(_ styles: CSSProperty...) -> Option {
    ...
    func tabIndex(_ index: Int) -> Option {
    ...
    func title(_ title: String) -> Option {
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> Option {
