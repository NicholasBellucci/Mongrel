...
public extension OptionGroup {
    ...
    func accessKey(_ key: String) -> OptionGroup {
    ...
    ///   attribute should be added.
    func allowsSpellcheck(_ value: Bool) -> OptionGroup {
    ...
    func `class`(_ name: String) -> OptionGroup {
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> OptionGroup {
    ...
    func customAttribute(key: String, value: String) -> OptionGroup {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> OptionGroup {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func hidden(_ value: Bool) -> OptionGroup {
    ...
    func id(_ id: String) -> OptionGroup {
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> OptionGroup {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> OptionGroup {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> OptionGroup {
    ...
    func styles(_ styles: CSSProperty...) -> OptionGroup {
    ...
    func tabIndex(_ index: Int) -> OptionGroup {
    ...
    func title(_ title: String) -> OptionGroup {
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> OptionGroup {
