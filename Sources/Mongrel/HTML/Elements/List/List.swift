...
public extension List {
    ...
    func accessKey(_ key: String) -> List {
        var copy = self
    ...
    func allowsSpellcheck(_ value: Bool) -> List {
        var copy = self
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> List {
        var copy = self
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> List {
        var copy = self
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> List {
        var copy = self
    ...
    func margin(_ edges: Edge.Margin..., length: Unit? = nil) -> List {
        var copy = self
    ...
    func padding(_ edges: Edge.Padding..., length: Unit? = nil) -> List {
        var copy = self
    ...
    func styles(_ styles: CSSProperty...) -> List {
        var copy = self
    ...
    func tabIndex(_ index: Int) -> List {
        var copy = self
    ...
    func title(_ title: String) -> List {
        var copy = self
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> List {
        var copy = self
