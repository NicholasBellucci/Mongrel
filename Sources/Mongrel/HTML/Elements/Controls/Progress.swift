...
public extension Progress {
    ...
    func customAttribute(key: String, value: String) -> Progress {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> Progress {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> Progress {
