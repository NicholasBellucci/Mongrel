...
public extension Details {
    ...
    func accessKey(_ key: String) -> Details {
    ...
    ///   attribute should be added.
    func allowsSpellcheck(_ value: Bool) -> Details {
    ...
    func `class`(_ name: String) -> Details {
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> Details {
    ...
    func customAttribute(key: String, value: String) -> Details {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> Details {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func hidden(_ value: Bool) -> Details {
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> Details {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> Details {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> Details {
    ...
    func styles(_ styles: CSSProperty...) -> Details {
    ...
    func tabIndex(_ index: Int) -> Details {
    ...
    func title(_ title: String) -> Details {
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> Details {
