...
public extension Break {
    ...
    func accessKey(_ key: String) -> Break {
    ...
    func allowsSpellcheck(_ value: Bool) -> Break {
    ...
    func `class`(_ name: String) -> Break {
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> Break {
    ...
    func customAttribute(key: String, value: String) -> Break {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> Break {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func hidden(_ value: Bool) -> Break {
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> Break {
    ...
    func styles(_ styles: CSSProperty...) -> Break {
    ...
    func tabIndex(_ index: Int) -> Break {
    ...
    func title(_ title: String) -> Break {
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> Break {
