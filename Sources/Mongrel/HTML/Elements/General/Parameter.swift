...
public extension Parameter {
    ...
    func accessKey(_ key: String) -> Parameter {
    ...
    func allowsSpellcheck(_ value: Bool) -> Parameter {
    ...
    func `class`(_ name: String) -> Parameter {
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> Parameter {
    ...
    func customAttribute(key: String, value: String) -> Parameter {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> Parameter {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func hidden(_ value: Bool) -> Parameter {
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> Parameter {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> Parameter {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> Parameter {
    ...
    func styles(_ styles: CSSProperty...) -> Parameter {
    ...
    func tabIndex(_ index: Int) -> Parameter {
    ...
    func title(_ title: String) -> Parameter {
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> Parameter {
