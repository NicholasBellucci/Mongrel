...
public extension Canvas {
    ...
    func customAttribute(key: String, value: String) -> Canvas {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> Canvas {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> Canvas {
