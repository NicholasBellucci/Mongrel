...
public extension Output {
    ...
    func accessKey(_ key: String) -> Output {
    ...
    func allowsSpellcheck(_ value: Bool) -> Output {
    ...
    func `class`(_ name: String) -> Output {
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> Output {
    ...
    func customAttribute(key: String, value: String) -> Output {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> Output {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func hidden(_ value: Bool) -> Output {
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> Output {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> Output {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> Output {
    ...
    func styles(_ styles: CSSProperty...) -> Output {
    ...
    func tabIndex(_ index: Int) -> Output {
    ...
    func title(_ title: String) -> Output {
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> Output {
