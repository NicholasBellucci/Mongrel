...
public extension GenericElement {
    ...
    func `class`(_ name: String) -> GenericElement {
        var copy = self
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> GenericElement {
        var copy = self
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> GenericElement {
        var copy = self
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func hidden(_ value: Bool) -> GenericElement {
        var copy = self
    ...
    func id(_ id: String) -> GenericElement {
        var copy = self
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> GenericElement {
        var copy = self
    ...
    func margin(_ edges: Edge.Margin..., length: Unit? = nil) -> GenericElement {
        var copy = self
    ...
    func padding(_ edges: Edge.Padding..., length: Unit? = nil) -> GenericElement {
        var copy = self
    ...
    func tabIndex(_ index: Int) -> GenericElement {
        var copy = self
    ...
    func title(_ title: String) -> GenericElement {
        var copy = self
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> GenericElement {
        var copy = self
