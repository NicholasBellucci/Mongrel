...
public extension Time {
    ...
    func accessKey(_ key: String) -> Time {
        var copy = self
    ...
    func allowsSpellcheck(_ value: Bool) -> Time {
        var copy = self
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> Time {
        var copy = self
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> Time {
        var copy = self
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> Time {
        var copy = self
    ...
    func margin(_ edges: Edge.Margin..., length: Unit? = nil) -> Time {
        var copy = self
    ...
    func padding(_ edges: Edge.Padding..., length: Unit? = nil) -> Time {
        var copy = self
    ...
    func tabIndex(_ index: Int) -> Time {
        var copy = self
    ...
    func title(_ title: String) -> Time {
        var copy = self
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> Time {
        var copy = self
