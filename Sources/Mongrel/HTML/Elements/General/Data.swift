...
public struct Data: Attributable {
...
public extension Data {
    ...
    func accessKey(_ key: String) -> Data {
    ...
    func allowsSpellcheck(_ value: Bool) -> Data {
    ...
    ///   attribute should be added.
    func contentEditable(_ value: Bool) -> Data {
    ...
    func customAttribute(key: String, value: String) -> Data {
    ...
    ///   - value: A Boolean value that determines whether the ``contenteditable``
    ///   attribute should be added.
    func draggable(_ value: Bool) -> Data {
    ...
    func language(_ code: LanguageCode, country: CountryCode? = nil) -> Data {
    ...
    func margin(_ edges: MarginSet, length: Unit? = nil) -> Data {
    ...
    func padding(_ edges: PaddingSet, length: Unit? = nil) -> Data {
    ...
    func styles(_ styles: CSSProperty...) -> Data {
    ...
    func tabIndex(_ index: Int) -> Data {
    ...
    func title(_ title: String) -> Data {
    ...
    ///   attribute should be added.
    func translated(_ value: Bool) -> Data {
